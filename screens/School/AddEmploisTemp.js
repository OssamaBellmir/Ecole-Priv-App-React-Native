...
function AddEmploisTemp() {
  ...
  const handleSaveSchedule = async () => {
    try {
      ...
      Toast.show({
        type: "success",
        text1: "Emploi du temps enregistré avec succès",
      });
      navigation.goBack();
    } catch (error) {
      ...
      Toast.show({
        type: "error",
        text1: "Erreur lors de l'enregistrement de l'emploi du temps",
      });
    }
  };
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.headerTitle}>Ajouter un Emploi du Temps</Text>
